...
Provide the main ingredients used in each dish alongside each dish. Do not use or list out images or anything else. Then ask the user which dish would they like the recipe for.
